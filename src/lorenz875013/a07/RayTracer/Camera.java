...
public class Camera {
    ...
    public Camera(Mat4 transformation, double fov, int width, int height) {
    ...
    public Ray genRay(double x, double y) {
        ...
        Vec3 finalDirection = transformation.transformDirection(direction);
        Vec3 finalOrigin = transformation.transformPoint(new Vec3(0,0,0));
